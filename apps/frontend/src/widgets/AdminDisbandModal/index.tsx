...
export const AdminDisbandModal = ({ squadName, players, onConfirm, onClose }: AdminDisbandModalProps) => {
			...
			>
				...
				<div className="px-16 py-14">
					...
					<p className="mt-6 text-[12px]" style={{ color: 'var(--at-text-section)' }}>
						Следующие игроки получат кит новобранца:
					</p>
