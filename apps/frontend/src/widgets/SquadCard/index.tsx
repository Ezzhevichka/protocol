    ...
    >
      ...
      >
        <div className="flex min-w-0 flex-1 items-center gap-12">
          ...
          <Text as="p" size="base" weight="semibold" className="font-manrope leading-22" style={{ color: SQUAD_COLORS.text }}>
            {squadName}
          </Text>
        </div>
        ...
        <div className="flex shrink-0 items-center gap-14">
          <span className="flex h-22 w-22 items-center justify-center overflow-hidden">
            <Image src={squadStatusIcon} alt={isOpen ? "Сквад открыт" : "Сквад закрыт"} width={17} height={20} className="h-20 w-17 object-contain" />
          </span>
          ...
          <div
            ...
            style={{
              ...
              backgroundColor: isCmd ? SQUAD_COLORS.playersBackgroundCmd : SQUAD_COLORS.playersBackgroundDefault,
            }}
          >
            <Text
              as="span"
