...
export const AdminClearNameModal = ({ squadName, squadNumber, onConfirm, onClose }: AdminClearNameModalProps) => {
			...
			>
				...
				<div className="flex shrink-0 items-center justify-end gap-8 px-16 pb-14">
					...
					<button
						...
						style={{
							color: '#fff',
							backgroundColor: 'rgba(210, 140, 40, 0.8)',
