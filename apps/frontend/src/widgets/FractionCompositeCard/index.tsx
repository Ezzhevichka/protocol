...
export const FractionCompositeCard = ({
  ...
  return (
    <section className={`w-636 overflow-hidden rounded-lg ${className}`} style={{ backgroundColor: FRACTION_COMPOSITE_COLORS.background }}>
      ...
      <div className="flex w-full flex-col gap-30 p-20">
        <Fraction playersAmount={playersAmount} fractionName={fractionName} doctrine="" flag={flag} variant="large" />
      ...
      <div className="flex h-166 w-full flex-col gap-16 p-20">
        <div className="flex w-full items-center gap-20">
          <div className="h-px flex-1" style={{ backgroundColor: FRACTION_COMPOSITE_COLORS.sectionDivider }} />
          <Text
            as="p"
            size="base"
            weight="medium"
