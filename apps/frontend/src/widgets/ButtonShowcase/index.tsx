    ...
    <section className="mt-32 flex w-full flex-col gap-20">
      ...
      <div className="flex w-full flex-col gap-16">
        {BUTTON_COMBOS.map((combo) => (
          <div key={`${combo.variant}-${combo.appearance}-${combo.size}`} className="flex w-full flex-wrap items-center gap-12">
      ...
      <div className="flex w-full flex-col gap-16">
        ...
        <Button showLeftIcon leftIcon={<Image src="/kits/automatics_rifleman_kit.svg" alt="" width={30} height={30} />} />
      </div>
    </section>
  );
};
