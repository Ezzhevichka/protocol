...
export const AdminKickModal = ({ playerNick, squadName, onConfirm, onClose }: AdminKickModalProps) => {
			...
			>
				...
				<div className="px-16 py-14">
					<p className="text-[13px] leading-relaxed" style={{ color: 'var(--at-text-nav)' }}>
						Вы уверены, что хотите кикнуть игрока{' '}
