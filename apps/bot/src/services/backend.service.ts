...
export async function checkBanBySteamId(input: {
    steamId: string;
    eosId?: string | null;
    name?: string | null;
}) {
    ...
    return response.data as {
        ...
        activeBan: null | { id: string; reason: string };
    };
}

export async function sendPlayerConnected(input: {
    serverId: number;
    steamId: string;
    eosId?: string | null;
    name?: string | null;
...
export async function sendPlayerDisconnected(input: {
    serverId: number;
    steamId: string;
    raw: string;
}) {
